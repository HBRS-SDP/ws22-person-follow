...
#         self.x_robot = 0
#         self.y_robot = 0
#         self.quat_robot = [0,0,0,0]

#         rospy.Subscriber('/hsrb/odom', Odometry, self.callback)
#         self.x_robot = 0
#         self.msg = Odometry()
...
#         self.x_robot = msg.pose.pose.position.y
#         self.temp(10)
#         # print('Got the value')
...
# #     def callback(self,obj_odometry):
# #         self.x_robot = obj_odometry.pose.pose.position.x
# #         # return self.x_
# #         # print(self.x_robot)
